...
let MembershipApplication = function(args){
  ...
  this.validationMessage = function(){
    if(this.isValid())
      ...
      return 'Age is outside of our limits of 15 and 100 years';
    else if(!this.heightIsValid())
      return 'Height is outside of our limits of 60 and 75 inches';
    else if(!this.weightIsValid())
      return 'Weight is outside of our limits of 100 and 300 pounds';
    else if(!this.nameIsValid())
      return 'A first name and last name is required';
